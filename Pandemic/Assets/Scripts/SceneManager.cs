...
public class SceneManager : MonoBehaviour
{
    ...
    void SetCameraToGraph()
    {
        ...
        wg.GetComponent<Window_Graph>().text1.text = "ÀüÃ¼ °¨¿°ÀÚ";
        wg.GetComponent<Window_Graph>().text2.text = "¾ÆÀÌ °¨¿°ÀÚ";
        wg.GetComponent<Window_Graph>().text3.text = "Ã»³â °¨¿°ÀÚ";
        wg.GetComponent<Window_Graph>().text4.text = "³ëÀÎ °¨¿°ÀÚ";
